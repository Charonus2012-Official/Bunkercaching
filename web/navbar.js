window.onload = function() {
    navbar_inner = '<div class="logo"><a href="/"><img id="nicn" src="../../data/logo/bunkercaching_pure_logo.png" alt="Bunkercaching" height="40"></a></div><ul id="menu"><li><a href="/Bunkercaching/map">Mapa</a></li><li><a href="/logs">Logy</a></li><li><a href="/about">O projektu</a></li><li ><a href="/auth" id="nav-profile">Přihlášení</a></li></ul><div class="menu-toggle" onclick="toggleMenu()"><span></span><span></span><span></span></div>'
